...
var schema43 = {"type":"object","additionalProperties":false,"required":["id","service","plane","status"],"properties":{"id":{"type":"string","description":"Unique node identifier within this workflow."},"name":{"type":"string","description":"Optional human-friendly label for the node."},"service":{"type":"string","description":"Symbolic service/capability identifier (e.g. a capabilities.json `id` like 'generate.f5_to_tts')."},"plane":{"$ref":"#/$defs/plane"},"status":{"$ref":"#/$defs/nodeStatus"},"params":{"type":["object","null"],"description":"Planner-defined parameters for this node (mapped onto capability input/parameters).","additionalProperties":true},"input":{"description":"Optional snapshot of node-specific input (resolved from context/previous outputs).","type":["object","array","string","number","boolean","null"]},"output":{"description":"Node output payload or artifact references; stored as part of the graph for later nodes.","type":["object","array","string","number","boolean","null"]},"error":{"$ref":"#/$defs/errorInfo"},"retries":{"type":["object","null"],"description":"Retry bookkeeping, if implemented (attempt count etc).","additionalProperties":false,"properties":{"attempt":{"type":"integer","minimum":0,"description":"Current attempt number for this node."},"maxAttempts":{"type":"integer","minimum":1,"description":"Maximum allowed attempts for this node."}}},"tags":{"type":["array","null"],"description":"Optional tags for debugging, grouping, or analytics.","items":{"type":"string"}},"telemetry":{"type":["object","null"],"description":"Optional telemetry hints (metrics keys, spans, etc.).","additionalProperties":true},"progressWeight":{"type":"number","minimum":0,"description":"Relative share of overall progress this node contributes; optional, defaults to 1."}}};
...
var missing0;
if(((((data.id === undefined) && (missing0 = "id")) || ((data.service === undefined) && (missing0 = "service"))) || ((data.plane === undefined) && (missing0 = "plane"))) || ((data.status === undefined) && (missing0 = "status"))){
...
validate31.errors = [{instancePath:instancePath+"/service",schemaPath:"#/properties/service/type",keyword:"type",params:{type: "string"},message:"must be string"}];
return false;
}
...
if(valid0){
if(data.progressWeight !== undefined){
var data18 = data.progressWeight;
var _errs45 = errors;
if(errors === _errs45){
if(typeof data18 == "number"){
if(data18 < 0 || isNaN(data18)){
validate31.errors = [{instancePath:instancePath+"/progressWeight",schemaPath:"#/properties/progressWeight/minimum",keyword:"minimum",params:{comparison: ">=", limit: 0},message:"must be >= 0"}];
return false;
}
}
else {
validate31.errors = [{instancePath:instancePath+"/progressWeight",schemaPath:"#/properties/progressWeight/type",keyword:"type",params:{type: "number"},message:"must be number"}];
return false;
}
}

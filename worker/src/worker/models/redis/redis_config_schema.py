...
class Pipelines(BaseModel):
    ...
    FIXED: str = Field(
        ...,
        description='Planner request type for creating execution pipelines from workflows registry.',
    )
...
class RedisConfiguration(BaseModel):
    ...
    planning: Planning | None = Field(None, description='Configuration for planner.')
